...
public class Get03 extends JsonPlaceHolderBaseUrl {
    ...
    public void get03() {
        ...
        Note 6: Hard assertion is more common because when there ia a failure, it immediately stops and we can fix the prob.
        Note 7: body("completed", equalTo(false)) --> equal to method checks if completed key equals to false.
         */
