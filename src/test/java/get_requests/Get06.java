...
public class Get06 extends HerOkuAppBaseUrl {
    ...
    public void get06() {
       ...
       Note 1: This is nested structure-->
        "bookingdates": {
                        "checkin": "2018-01-01",
                        "checkout": "2019-01-01"

                        To assert this we have to follow this syntax -->  "bookingdates.checkout", equalTo("2019-01-01")

        Note 2: Can we take this value "111" out of the parentheses and use it for mathematical operation?

        There is a way--> Json path method

        JSONPath is a query language for JSON, similar to XPath for XML. It allows you to select
        and extract data from a JSON document. You use a JSONPath expression to traverse the path
        to an element in the JSON structure.

        Note 3: .assertAll() if you dont use this at the end, everytime your assertion will pass.
