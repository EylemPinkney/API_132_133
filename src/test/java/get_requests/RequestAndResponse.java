...
public class RequestAndResponse {
    ...
    2) We use RestAssured library for API Automation Testing(sending the request, getting the response)
    3) We use Junit library for doing tests.
    4) To type automation script fallow these steps:
